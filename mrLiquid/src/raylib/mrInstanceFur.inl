/**
 * @file   mrInstanceFur.inl
 * @author gga
 * @date   Fri Aug  3 09:33:02 2007
 * 
 * @brief  
 * 
 * 
...
void mrInstanceFur::write_properties( miInstance* i ) throw()
{
   mrInstanceObjectBase::write_properties(i);
}


void mrInstanceFur::write()
{
   write_each_material();
   ...
   valI = fur->transparency; 
   MRL_INT_VALUE( &valI );
   MRL_PARAMETER( "finalgather" );
   valI = fur->finalgather; 
   MRL_INT_VALUE( &valI );
#else
   valI = 3;
   MRL_PARAMETER( "reflection" );
